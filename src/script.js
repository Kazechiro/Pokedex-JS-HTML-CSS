...
const pokemonType2 = document.querySelector('.pokemon_type2') || null;
...
const renderPokemon = async (pokemon) => {
  ...
  input.value = '';
    ...
    pokemonType.innerHTML = 'no type'
    pokemonType2.innerHTML = 'no type'
    pokemonNumber.innerHTML = '?'
    pokemonImage.src = "/images/interrogacao.png"
    input.value = '';
